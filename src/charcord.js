...
const propertiesToCopy = [
  // RTL support
  'direction',
  'boxSizing', // on Chrome and IE, exclude the scrollbar, so the mirror div wraps exactly as the textarea does
  'width',
  'height',
  'overflowX', // copy the scrollbar for IE
  'overflowY',
  'borderTopWidth',
  'borderRightWidth',
  'borderBottomWidth',
  ...
  'paddingRight',
  'paddingBottom',
  'paddingLeft', // https://developer.mozilla.org/en-US/docs/Web/CSS/font
  'fontStyle',
  'fontVariant',
  'fontWeight',
  'fontStretch',
  ...
  'textAlign',
  'textTransform',
  'textIndent', // might not make a difference, but better be safe
  'textDecoration',
  'letterSpacing',
  'wordSpacing',
  'tabSize',
 ...
 */
export const getScrollAdjustedCharacterCoordinates = (input, index) => {
 ...
 * @param index The index of the character to calculate for.
 */
export const getAbsoluteCharacterCoordinates = (input, index) => {
  const {
    top: relativeTop,
    left: relativeLeft,
    height,
